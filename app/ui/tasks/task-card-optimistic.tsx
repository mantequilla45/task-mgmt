...
export default function TaskCardOptimistic({ task, boardId, onDragStart, onDelete, onUpdate }: TaskCardProps) {
  ...
  const handleDelete = async () => {
    if (confirm('Are you sure you want to delete this task?')) {
      ...
      try {
        ...
        // Could add error handling to restore the task if needed
      }
    }
  };
        ...
        <div className="space-y-2.5">
          <div className="flex items-start gap-2">
            ...
            <button
              ...
              className="text-zinc-400 hover:text-red-600 transition-colors p-0.5 cursor-pointer"
              title="Delete task"
            >
